...
<div class="main-div">
  ...
  <table width="100%" id="general-table">
      <tr>
        ...
        <td>
          <input type='text' name='category_name' maxlength="20" value='' size='27' />
        </td>
      </tr>
      <tr>
        ...
        <td>
          ...
          <?php foreach($category_list as $row):?>
            <option value="<?php echo $row['category_id'];?>" ><?php echo str_repeat('&nbsp;&nbsp;', $row['level']),  $row['category_name'];?></option>
          <?php endforeach;?>
          </select>
        </td>
      </tr>
