...
<head>
    ...
    <title>
        GSM手机_手机类型_SHOP演示站 - Powered by ECShop
    </title>
    <link rel="shortcut icon" href="favicon.ico" />
    <link rel="icon" href="animated_favicon.gif" type="image/gif" />
    <link href="./styles/index.css" rel="stylesheet" type="text/css" media="screen"/>
    <!-- link href="./styles/style.css" rel="stylesheet" type="text/css" /-->
    <link href="http://localhost/shop/styles/style.css" rel="stylesheet" type="text/css" />
</head>
...
<body>
    ...
    <div id="body">
            ...
            <div class="subnav">
                <div>
                    ...
                    <span class="right subnav_right">
                        <img src="images/line.gif" border="0" id="categorie_ico1">
                    </span>
                </div>
                <ul>
                    <li>
                ...
                <div>
                    ...
                    <span class="right subnav_right">
                        <img src="images/line.gif" border="0" id="categorie_ico2">
                    </span>
                </div>
                <ul>
                    <li>
                ...
                <div>
                    ...
                    <span class="right subnav_right">
                        <img src="images/line.gif" border="0" id="categorie_ico3">
                    </span>
                </div>
                <ul>
                    <li>
                ...
                <ul>
                    <li>
                        <div class="subinfo_body_top10_l">
                            <a href="#">
                                <img src="images/17_thumb_P_1241969394537.jpg" alt=""
                                class="samllimg" />
                            </a>
                        </div>
        ...
        <div class="body_r" style=" display:inline">
            ...
            <!-- 循环输出 精品 -->
            <?php foreach($best_list as $row):?>
                <li>
                    <a href="#">
                        <img src="upload/<?php echo $row['goods_thumb'];?>" alt="<?php echo $row['goods_name'];?>" />
                    </a>
                    <p class="pname">
                        <a href="#" title="<?php echo $row['goods_name'];?>">
                           <?php echo $row['goods_name'];?>
                        </a>
                    </p>
                    <p class="price">
                        ￥<?php echo $row['goods_price'];?>元
                    </p>
                </li>
            <?php endforeach;?>
            ...
            <ul class="productlist">
                <li>
                    <a href="#">
                        <img src="images/17_thumb_P_1241969394537.jpg" alt="诺基亚N85" />
                    </a>
                    <p class="pname">
                        <a href="#" title="诺基亚N85">
    ...
    <div class="footert">
        <div class="footertl">
            <div class="footert_1">
                <img src="images/logo21.gif">
            </div>
            <div class="footert_2">
                抢购热线（9:00-18:00）
                <p>
                    <img src="images/tel2.gif">
                </p>
            </div>
        </div>
        <div class="footertr">
    ...
    <div class="footer">
        ...
        <div class="footbot">
            ...
            <p>
                &copy; 2013  青岛大学浩园4号楼411室 版权所有，并保留所有权利。
            </p>
            <div class="clear">
            </div>
        </div>
